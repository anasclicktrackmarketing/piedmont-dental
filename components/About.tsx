...
const DOCTORS: Doctor[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "A co-owner of Piedmont Dental By Design, Dr. Ma began his path into dentistry with neurobiology at UC Davis before graduating with honors from the University of Pennsylvania School of Dental Medicine — bringing both rigor and craft to every restoration.",
