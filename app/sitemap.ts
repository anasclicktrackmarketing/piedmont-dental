...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE}/resources/financing`, lastModified, changeFrequency: "monthly", priority: 0.65 },
    { url: `${SITE}/resources/insurance`, lastModified, changeFrequency: "monthly", priority: 0.65 },
    { url: `${SITE}/resources/patient-forms`, lastModified, changeFrequency: "monthly", priority: 0.65 },
    { url: `${SITE}/resources/dental-videos`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE}/resources/links`, lastModified, changeFrequency: "yearly", priority: 0.5 },
    { url: `${SITE}/resources/invisalign`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE}/resources/surgery`, lastModified, changeFrequency: "monthly", priority: 0.65 },
    { url: `${SITE}/resources/smile-analysis`, lastModified, changeFrequency: "monthly", priority: 0.65 },
    { url: `${SITE}/resources/gummy-smile`, lastModified, changeFrequency: "monthly", priority: 0.65 },
    { url: `${SITE}/resources/cosmetic-dentistry`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE}/resources/dental-implants`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE}/resources/porcelain-veneers`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE}/resources/invisalign-results`, lastModified, changeFrequency: "monthly", priority: 0.55 },
    { url: `${SITE}/resources/full-mouth-restoration`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE}/resources/restorations`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE}/resources/restorations/crowns-caps`, lastModified, changeFrequency: "monthly", priority: 0.55 },
    { url: `${SITE}/resources/restorations/dentures`, lastModified, changeFrequency: "monthly", priority: 0.55 },
    { url: `${SITE}/smile-gallery`, lastModified, changeFrequency: "monthly", priority: 0.75 },
    { url: `${SITE}/smile-gallery/other-procedures`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE}/smile-gallery/composite-fillings`, lastModified, changeFrequency: "monthly", priority: 0.55 },
    { url: `${SITE}/smile-gallery/dental-implants`, lastModified, changeFrequency: "monthly", priority: 0.55 },
    { url: `${SITE}/smile-gallery/porcelain-crowns-caps`, lastModified, changeFrequency: "monthly", priority: 0.55 },
    { url: `${SITE}/smile-gallery/composite-fillings-recent`, lastModified, changeFrequency: "monthly", priority: 0.55 },
